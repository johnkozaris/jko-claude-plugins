...
1. Detect the solution and SDK context:
   ...
   - whether the app is a Kestrel API, worker, real-time host (SignalR / WebSockets / SSE), or a mix
...
Summarize the detected shape of the backend: host style, hosting/proxy posture, layers, projects, DI approach, data strategy, and real-time transport choice (SignalR / WebSockets / SSE) when applicable.
