...
| DN-16 | Hosting/wiring leakage         | composition-root or local-orchestration code carries workflow or data behavior                       | move workflow/data into application or domain layers; keep wiring orchestration-only |
